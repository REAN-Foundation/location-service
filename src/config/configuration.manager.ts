...
import * as defaultConfiguration from '../../location.config.json';
import * as localConfiguration from '../../location.config.local.json';
import { AuthenticationType, AuthorizationType, Configurations, EmailServiceProvider, FileStorageProvider, SMSServiceProvider } from './configuration.types';
...
export class ConfigurationManager {
    ...
    public static UploadTemporaryFolder = (): string => {
        ...
        // serverless functions run in /var/task, Which does not allowed to create files
        // only location allowed to create files is ./tmp
